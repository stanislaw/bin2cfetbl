...
class TableDefReader:
    ...
    def read_tbl_def_from_section(tbl_filedef_section, tbl_def_symbol):
        print("--- table definitions (CFE_TBL_FileDef_t) ---")
        print(tbl_filedef_section.content)
        ...
        print("table name: {}".format(table_name_string))
        ...
        print("tbl description: {}".format(description_string))
        ...
        print("target_file_name: {}".format(target_file_name_string))
        ...
        print("object_size: {}".format(object_size))
